...
const EditProfile = () => {
  ...
  return (
    <form className="operations_manager_edit_profile">
      <div className="operations_manager_edit_profile__profile-picture">
        <h1>EDIT PROFILE</h1>
        <img
      ...
      <div className="operations_manager_edit_profile__fields">
        ...
        <div className="operations_manager_edit_profile__button-group">
