...
const EditProfile = () => {
    ...
    return (
        <form className='technical_staff_edit_profile'>
            <div className='technical_staff_edit_profile__profile-picture'>
                <h1>EDIT PROFILE</h1>
                <img src='https://plus.unsplash.com/premium_photo-1689568126014-06fea9d5d341?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fHByb2ZpbGUlMjBwaWN0dXJlfGVufDB8fDB8fHww' alt="" />
